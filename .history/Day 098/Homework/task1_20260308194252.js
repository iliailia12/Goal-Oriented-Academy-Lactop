...
let phone1 = {brand: 'Apple',model: 'Iphone 18',aboutTelephone: function() {console.log("this is " + this.brand + " " + this.model)}
}

let phone2 = {brand: "Samsung",model: "Galaxy S23",aboutTelephone: function() {console.log("this is " + this.brand + " " + this.model)}
}