...
month === 2? console.log('იანვარი'):
month === 3? console.log('იანვარი'):
month === 4? console.log('იანვარი'):
month === 5? console.log('იანვარი'):
month === 6? console.log('იანვარი'):
month === 7? console.log('იანვარი'):
month === 8? console.log('იანვარი'):
month === 9? console.log('იანვარი'):
