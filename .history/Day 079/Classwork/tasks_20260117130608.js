...
// ternary
week_daye === 1 ? console.log('ირშაბათი') :
week_daye === 2 ? console.log('თებერვალი') :
week_daye === 3 ? console.log('მარტი') :
week_daye === 4 ? console.log('აპრილი') :
week_daye === 5 ? console.log('მაისი') :
week_daye === 6 ? console.log('ივნისი') :
week_daye === 7 ? console.log('ივლისი') :
