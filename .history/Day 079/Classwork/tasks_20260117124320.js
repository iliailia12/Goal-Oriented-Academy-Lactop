...
if (month == 1){
    ...
    console.log('invalid month ასეთი თვე არ არსებობს')
}
...
if (month === 1) console.log('იანვარი');
else if (month === 2) console.log('თებერვალი');
else if (month === 3) console.log('მარტი');
else if (month === 4) console.log('აპრილი');
else if (month === 5) console.log('მაისი');
else if (month === 6) console.log('ივნისი');
else if (month === 7) console.log('ივლისი');
else if (month === 8) console.log('აგვისტო');
else if (month === 9) console.log('სექტემბერი');
else if (month === 10) console.log('ოქტომბერი');
else if (month === 11) console.log('ნოემბერი');
else if (month === 12) console.log('დეკემბერი');
